...
* Era is calculated automatically - If 'year', the leading part of Personnummer, is using only two digits instead of four (e.g. '89' instead of '1989') then its era part is calculated automatically
