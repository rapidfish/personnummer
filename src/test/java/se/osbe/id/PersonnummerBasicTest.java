...
public class PersonnummerBasicTest {
    ...
    final int ERA_MINUS_ONE = now().get(YEAR_OF_ERA) / 100 - 1;
    ...
    @Test
    public void testSsnParseOneOK() {
        // OK test - 4 diffrent lengths in input, 4 controlled length for output

        // output 10 length
        Assert.assertEquals("4604300014", Personnummer.parse("4604300014").get().toString10());
        Assert.assertEquals("4604300014", Personnummer.parse("460430-0014").get().toString10());
        Assert.assertEquals("4604300014", Personnummer.parse("460430+0014").get().toString10());
        Assert.assertEquals("4604300014", Personnummer.parse("194604300014").get().toString10());
        Assert.assertEquals("4604300014", Personnummer.parse("19460430-0014").get().toString10());

        // output 11 length
        Assert.assertEquals("460430-0014", Personnummer.parse("4604300014").get().toString11());
        Assert.assertEquals("460430-0014", Personnummer.parse("460430-0014").get().toString11());
        Assert.assertEquals("460430+0014", Personnummer.parse("460430+0014").get().toString11());
        Assert.assertEquals("460430-0014", Personnummer.parse("194604300014").get().toString11());
        Assert.assertEquals("460430-0014", Personnummer.parse("19460430-0014").get().toString11());

        // output 12 length
        Assert.assertEquals("194604300014", Personnummer.parse("4604300014").get().toString12());
        Assert.assertEquals("194604300014", Personnummer.parse("460430-0014").get().toString12());
        Assert.assertEquals("184604300014", Personnummer.parse("460430+0014").get().toString12());
        Assert.assertEquals("194604300014", Personnummer.parse("194604300014").get().toString12());
        Assert.assertEquals("194604300014", Personnummer.parse("19460430-0014").get().toString12());

        // output 13 length
        Assert.assertEquals("19460430-0014", Personnummer.parse("4604300014").get().toString13());
        Assert.assertEquals("19460430-0014", Personnummer.parse("460430-0014").get().toString13());
        Assert.assertEquals("18460430-0014", Personnummer.parse("460430+0014").get().toString13());
        Assert.assertEquals("19460430-0014", Personnummer.parse("194604300014").get().toString13());
        Assert.assertEquals("19460430-0014", Personnummer.parse("19460430-0014").get().toString13());
    }

    @Test
    public void testPnrParsePlusHundredYearsOldOK() {
        assertTrue(Personnummer.parse("010101+0106").get().isHundredYears());
        assertTrue(Personnummer.parse("010101+0106").get().getBirthDate().isBefore(now().minusYears(100)));
    }
    ...
    public void testFutureDateNOK() {
        var pOpt = Personnummer.parse("211212121212");
    ...
    public void testSsn10Equals() {
        _pnrOKList.stream().filter(p -> p.length() == 10).forEach(p -> {
            Assert.assertEquals(p, Personnummer.parse(p).get().toString10());
            Assert.assertEquals(10, Personnummer.parse(p).get().toString10().length());
        });
    }
    ...
    public void testSsn11Equals() {
        _pnrOKList.stream().filter(p -> p.length() == 11).forEach(p -> {
            Assert.assertEquals(p, Personnummer.parse(p).get().toString11());
            Assert.assertEquals(11, Personnummer.parse(p).get().toString11().length());
        });
    }
    ...
    public void testSsn12Equals() {
        _pnrOKList.stream().filter(p -> p.length() == 12).forEach(p -> {
            Assert.assertEquals(p, Personnummer.parse(p).get().toString12());
            Assert.assertEquals(12, Personnummer.parse(p).get().toString12().length());
        });
    }
    ...
    public void testSsn13Equals() {
        _pnrOKList.stream().filter(p -> p.length() == 13).forEach(p -> {
            Assert.assertEquals(p, Personnummer.parse(p).get().toString13());
            Assert.assertEquals(13, Personnummer.parse(p).get().toString13().length());
        });
    }
